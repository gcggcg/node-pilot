...
This project is indexed by GitNexus as **node-pilot** (18769 symbols, 50023 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
