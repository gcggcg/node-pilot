...
This project is indexed by GitNexus as **node-pilot** (13009 symbols, 34955 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
